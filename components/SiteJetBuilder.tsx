...
export default function SiteJetBuilder() {
    return (
        <div className="flex flex-col items-center justify-center w-full h-auto mt-5">
            <div className="p-10 flex flex-col lg:flex-row ms:flex-col-reverse items-center justify-between max-w-[1000px] gap-5 bg-white p-6 shadow-md rounded-lg border-double border-l-8 border-[red] ml-10 mr-10">
